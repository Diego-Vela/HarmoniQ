  ...
  return (
    <View className="flex-1 bg-dark-300">
      ...
      <ScrollView className="flex-1 px-10" showsHorizontalScrollIndicator={false} contentContainerStyle={{minHeight: '100%', paddingBottom: 10}}>
        <TouchableOpacity className="mt-10 bg-blue-500 py-3 px-6 rounded-full" onPress={() => router.push("/missions")}>
          <Text className="text-white text-center font-semibold">Go to Missions</Text>
        </TouchableOpacity>
        <View className="flex flex-col justify-between items-center mt-10 bg-transparent rounded-lg p-6">
          <Lesson/>
          <Lesson/>
          <Lesson/>
          <Lesson/>
